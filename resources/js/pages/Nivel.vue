    ...
    <div class="page">
        ...
        <main class="content">
            <section class="center-block">
                ...
                <h2>Qual seu <span>Nível de Experiência?</span></h2>
                ...
                <div class="options">
                    ...
                    >
                        ...
                        <div class="check">
                            ...
                            >
                                <span v-if="selectedLevel === 'iniciante'"
                                    >✓</span
                                >
                            </div>
                        </div>
                    ...
                    >
                        ...
                        <div class="check">
                            ...
                            >
                                <span v-if="selectedLevel === 'intermediario'"
                                    >✓</span
                                >
                            </div>
                        </div>
                    ...
                    >
                        ...
                        <div class="check">
                            ...
                            >
                                <span v-if="selectedLevel === 'avancado'"
                                    >✓</span
                                >
                            </div>
                        </div>
        ...
        <footer class="footer-simple">
            © 2026 Racket Advisor. Todos os direitos reservados. Software
            <strong>Goettenauer</strong>.
        </footer>
    </div>
</template>
...
.page {
    ...
    overflow: hidden;
    background:
        linear-gradient(rgba(245, 247, 249, 0.9), rgba(245, 247, 249, 0.9)),
