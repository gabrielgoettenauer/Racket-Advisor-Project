      ...
      <section class="center-block">
        ...
        <div class="panel">
          ...
          <div class="inner-card">
            <div class="question-group">
              ...
              <div class="strength-scale">
                ...
                <button
                  ...
                  :key="value"
                  class="strength-dot"
                  :class="{ active: selectedStrength === value }"
            ...
            <div class="question-group">
              <p class="question-text">
                Você tem dor ou histórico de lesões no ombro, cotovelo ou punho?
              </p>

              <div class="button-options">
                <button
                  class="choice-button"
                  :class="{ selected: selectedInjury === 'sim' }"
                ...
                <button
                  class="choice-button"
                  :class="{ selected: selectedInjury === 'nao' }"
            ...
            <div class="question-group">
              <p class="question-text">
                Com que frequência você treina ou joga Beach Tennis por semana?
              </p>

              <div class="button-options frequency">
                <button
                  class="choice-button small"
                  :class="{ selected: selectedFrequency === '1-2' }"
                ...
                <button
                  class="choice-button small"
                  :class="{ selected: selectedFrequency === '3-5' }"
                ...
                <button
                  class="choice-button small"
                  :class="{ selected: selectedFrequency === '6-7' }"
...
const canProceed = computed(() => {
  return selectedStrength.value && selectedInjury.value && selectedFrequency.value
})
