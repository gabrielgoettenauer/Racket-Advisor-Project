    ...
    <div class="page">
        ...
        <main class="content">
            <section class="center-block">
                ...
                <h1>Analisando <span>seu perfil...</span></h1>
                ...
                <h2>Seu <span>estilo</span> em quadra</h2>
                ...
                <div class="question-block">
                    ...
                    <div class="options-grid">
                        <button
                            class="option-card"
                            :class="{
                                selected: selectedStyle === 'ataque-aereo',
                            }"
                        ...
                        >
                            ...
                            <div class="check">
                                <div
                                    ...
                                    :class="{
                                        active:
                                            selectedStyle === 'ataque-aereo',
                                    }"
                                >
                                    <span
                                        v-if="selectedStyle === 'ataque-aereo'"
                                        >✓</span
                                    >
                                </div>
                            </div>
                        ...
                        <button
                            class="option-card"
                            :class="{
                                selected: selectedStyle === 'giro-volume',
                            }"
                        ...
                        >
                            ...
                            <div class="check">
                                <div
                                    class="radio"
                                    :class="{
                                        active: selectedStyle === 'giro-volume',
                                    }"
                                >
                                    <span v-if="selectedStyle === 'giro-volume'"
                                        >✓</span
                                    >
                                </div>
                            </div>
                        ...
                        <button
                            class="option-card"
                            :class="{
                                selected: selectedStyle === 'toque-defesa',
                            }"
                        ...
                        >
                            ...
                            <div class="check">
                                <div
                                    ...
                                    :class="{
                                        active:
                                            selectedStyle === 'toque-defesa',
                                    }"
                                >
                                    <span
                                        v-if="selectedStyle === 'toque-defesa'"
                                        >✓</span
                                    >
                                </div>
                            </div>
                ...
                <div class="question-block second">
                    <div class="question-title">
                        <span class="question-icon">🎯</span>
                        <p>
                            Com que frequência você acerta o
                            <span>sweet spot</span> (centro da raquete)?
                        </p>
                    </div>
                    ...
                    <div class="options-grid">
                        <button
                            class="option-card"
                            :class="{
                                selected: selectedSweetSpot === 'quase-sempre',
                            }"
                        ...
                        >
                            ...
                            <div class="check">
                                ...
                                >
                                    <span
                                        v-if="
                                            selectedSweetSpot === 'quase-sempre'
                                        "
                                        >✓</span
                                    >
                                </div>
                        ...
                        <button
                            ...
                            :class="{
                                selected:
                                    selectedSweetSpot === 'maioria-das-vezes',
                            }"
                        ...
                        <button
                            class="option-card"
                            :class="{
                                selected: selectedSweetSpot === 'raramente',
                            }"
                        ...
                        >
                            ...
                            <div class="check">
                                <div
                                    ...
                                    :class="{
                                        active:
                                            selectedSweetSpot === 'raramente',
                                    }"
                                >
                                    <span
                                        v-if="selectedSweetSpot === 'raramente'"
                                        >✓</span
                                    >
                                </div>
                            </div>
